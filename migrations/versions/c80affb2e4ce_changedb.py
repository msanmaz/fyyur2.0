...
Revision ID: c80affb2e4ce
Revises: cea8a7f8e272
Create Date: 2020-04-14 15:24:37.913457
...
revision = 'c80affb2e4ce'
down_revision = 'cea8a7f8e272'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('seeking_desription', sa.String(), nullable=True),
